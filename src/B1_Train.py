...
from src.helper import StainingDataset

parser = argparse.ArgumentParser()
parser.add_argument('--epoch', type=int, default=0, help='starting epoch')
parser.add_argument('--n_epochs', type=int, default=100, help='number of epochs of training')
parser.add_argument('--batchSize', type=int, default=1, help='size of the batches')
parser.add_argument('--dataroot', type=str, default='data/Train_dataset', help='root directory of the dataset')
...
for epoch in range(opt.epoch, opt.n_epochs):
    ...
    if not os.path.exists('./data/checkpoints/output_{}_{}'.format(info,dataset_name)):
        os.mkdir('./data/checkpoints/output_{}_{}'.format(info,dataset_name))

    torch.save(netG_A2B.state_dict(), './data/checkpoints/output_{}_{}/netG_A2B_{}.pth'.format(info,dataset_name,epoch))
    torch.save(netG_B2A.state_dict(), './data/checkpoints/output_{}_{}/netG_B2A_{}.pth'.format(info,dataset_name,epoch))
    torch.save(netD_A.state_dict(), './data/checkpoints/output_{}_{}/netD_A_{}.pth'.format(info,dataset_name,epoch))
    torch.save(netD_B.state_dict(), './data/checkpoints/output_{}_{}/netD_B_{}.pth'.format(info,dataset_name,epoch))
###################################
